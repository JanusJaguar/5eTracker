...
def build_skills(parent):
    ...
    for stat, skills in grouped_skills.items():

        card = ttk.LabelFrame(frame, text=f" {stat} ")
        ...
        save_frame.pack(side="left", padx=12)
